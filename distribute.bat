...
ucon64 -q --snes --chk tmnt4_msu1_emulator.sfc
ucon64 -q --mki=tmnt4_original.sfc tmnt4_msu1.sfc
ucon64 -q --mki=tmnt4_original.sfc tmnt4_msu1_emulator.sfc
copy tmnt4_msu1.ips TurtleInTime_MSU1
copy tmnt4_msu1_emulator.ips TurtleInTime_MSU1
...
copy MusicCredits.txt TurtleInTime_MSU1
